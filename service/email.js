...
<html xmlns="http://www.w3.org/1999/xhtml" lang="${values.lang}" xml:lang="${values.lang}">
    <head>
                                                            ...
                                                            <table class="row masthead"><tbody><tr> <!-- Masthead -->
                                                                        <th class="small-12 large-12 columns first last">
                                                                            <table>
                                                                                <tr>
                                                                                    <th>
                                                                                        <h1 class="text-center">${values.welcome}</h1>
                                                                                        <center data-parsed="">
                                                                ...
                                                                <table class="row grey"><tbody><tr>
                                                                            <th class="small-12 large-12 columns first last">
                                                                                <table>
                                                                                    <tr>
                                                                                        <th>
                                                                                            <p class="text-center footercopy">&#xA9; ${values.footerMessage}</p>
                                                                                        </th>
                                                                                        <th class="expander"></th>
                                                                                    </tr>
                                                                                </table>
...
module.exports = {Init, SendMail, EmailTemplate};